...
public class TestGenerator {
    ...
    public void testGenerator(){
        ...
        globalConfig.setOutputDir("D:\\Z_lhy\\codeGen");//生成文件的输出目录
        ...
        String url = "jdbc:mysql://127.0.0.1:3306/db_dict?useSSL=true&useUnicode=true&characterEncoding=UTF8&serverTimezone=GMT";
        ...
        strategyConfig.setInclude("sys_teacher");
